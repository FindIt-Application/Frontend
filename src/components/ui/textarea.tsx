...
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
	({ className, useAnimatedPlaceholder, ...props }, ref) => {
		...
		return (
			...
			>
				{useAnimatedPlaceholder && !inputValue && (
					<span className="pointer-events-none absolute left-3 top-3 text-lg text-neutral-600">
				...
				<textarea
					...
					className={cn(
                        ...
                        flex min-h-[80px] w-full rounded-xl border-none
					...
					ref={ref}
					placeholder="" // can be overridden by props
					{...props}
				/>
			</motion.div>
		);
